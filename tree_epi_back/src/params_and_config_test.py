...
from epidemic_models.utils.dynamics_helpers import set_SIR
from epidemic_models.utils.common_helpers import get_initial_host_number, get_total_host_number
...
def test_model_name():
    ...
    model_name = prm_conf.get_model_name(compartments='SIR', dispersal_model=dispersal_conf.model_type)
    ...
    model_name = prm_conf.get_model_name(compartments='SEIR', sporulation_model=sporulation.model,
