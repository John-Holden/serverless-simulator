...
def run_SIR():
    runtime = set_runtime(steps=500)
    dispersal = set_dispersal(model='ga', dispersal_param=50)
    infection_dynamics = set_infection_dynamics(compartments='SIR', beta_factor=25, pr_approx=False)
    infectious_lt = set_infectious_lt(distribution='step', life_time_parameter=10)
